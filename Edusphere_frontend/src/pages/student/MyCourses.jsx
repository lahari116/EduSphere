    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {tab === 'enrolled' && (
        <div className="flex items-center justify-between gap-4 bg-gradient-to-r from-primary-50 to-purple-50 border border-primary-100 rounded-2xl px-5 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-slate-800 text-sm">Want to join a new course?</p>
              <p className="text-xs text-slate-500 mt-0.5">Browse the catalog and send an enrollment request to your coordinator.</p>
            </div>
          </div>
      ...
      {tab === 'browse' && (
        <div className="flex items-center gap-2 text-sm text-slate-600 bg-blue-50 border border-blue-100 rounded-xl px-4 py-3">
          ...
          <span>Click <strong>Request Enrollment</strong> to send a request. Your coordinator will review and approve it.</span>
        </div>
      )}
