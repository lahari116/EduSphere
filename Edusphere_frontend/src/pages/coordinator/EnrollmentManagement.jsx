...
import { UserPlus, Trash2, Users, Search, Clock, CheckCircle2, XCircle } from 'lucide-react'
...
export default function EnrollmentManagement() {
  ...
  // Also fetch user profiles for pending requests
  ...
  const userMap = [...userProfileQueries, ...pendingUserQueries].reduce((acc, q) => {
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-0.5">Manage enrollments and review student requests</p>
        </div>
