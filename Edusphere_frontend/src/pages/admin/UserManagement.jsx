    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-0.5">{activeUsers.length} active · {inactiveUsers.length} inactive</p>
        </div>
      ...
      <Modal open={!!deleteConfirm} onClose={() => setDeleteConfirm(null)} title="Deactivate User" size="sm">
        <div className="space-y-4">
          <p className="text-slate-600 text-sm">
            Are you sure you want to deactivate <strong>{deleteConfirm?.firstName} {deleteConfirm?.lastName}</strong>? They will no longer be able to log in but will remain visible in the user list.
          </p>
          <div className="flex gap-3">
